...
*/
/**************************************************************************/
Adafruit_TCS34725::Adafruit_TCS34725(tcs34725IntegrationTime_t it, tcs34725Gain_t gain) : sensorReadyTime{0}
{
...
*/
/**************************************************************************/
bool Adafruit_TCS34725::getRawData (uint16_t *r, uint16_t *g, uint16_t *b, uint16_t *c)
{
  if (!_tcs34725Initialised) begin();

  unsigned long curTime = millis();

  if(sensorReadyTime > curTime) {
    return false;
  }
  ...
  *b = read16(TCS34725_BDATAL);
  ...
  switch (_tcs34725IntegrationTime)
  {
    case TCS34725_INTEGRATIONTIME_2_4MS:
      //delay(3);
      sensorReadyTime = curTime + 3;
      break;
    case TCS34725_INTEGRATIONTIME_24MS:
      //delay(24);
      sensorReadyTime = curTime + 24;
      break;
    case TCS34725_INTEGRATIONTIME_50MS:
      //delay(50);
      sensorReadyTime = curTime + 50;
      break;
    case TCS34725_INTEGRATIONTIME_101MS:
      //delay(101);
      sensorReadyTime = curTime + 101;
      break;
    case TCS34725_INTEGRATIONTIME_154MS:
      //delay(154);
      sensorReadyTime = curTime + 154;
      break;
    case TCS34725_INTEGRATIONTIME_700MS:
      //delay(700);
      sensorReadyTime = curTime + 700;
      break;
  }
